...
public class MainActivity extends AppCompatActivity
        ...
        Button btnCreate;Button btnView;Button btnDelete;Button btnUpdate;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(Intent.EXTRA_EMAIL, "condorelibrary@conestoga.on.ca");
        ...
        btnView=(Button)findViewById(R.id.btnViewItems);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        }else if (id==R.id.account_update){
            ...
            builder.setPositiveButton(
                    ...
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Toast.makeText(getApplicationContext(),"Your account will be deleted within 24 hours",Toast.LENGTH_LONG).show();
